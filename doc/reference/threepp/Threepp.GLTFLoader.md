...
============================================================ 汎用 glTF / GLB ローダ (VRM 以外のモデル用) VRM ではない一般の 3D モデル(小物/地形/建物/アニメ付きモデル)を読む。 GLTFLoader.loadStorage() が返す GLTFModel の getScene() (Group) を Scene に add し、setPosition/setScale/setRotation で自然に配置する。 ============================================================
